package fontys.s3.carspacebackend.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(fontys.s3.carspacebackend.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(fontys.s3.carspacebackend.configuration.security.isauthenticated.IsAuthenticated)")
