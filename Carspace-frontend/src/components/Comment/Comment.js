...
function Comment(props) {
  ...
  return (
    <div className="comment bg-light rounded p-3 mb-4">
        ...
        </div>
        {
          ...
          <div className="col-auto">
            <Tooltip title={<Typography fontSize={14}><span className="text-danger-light">Delete comment</span></Typography>} placement="left">
              <button data-bs-toggle="modal" data-bs-target="#confirmCommentDeleteModal" className="btn btn-danger ms-auto"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
      ...
      <p className="ms-4">{props.comment.text}</p>
